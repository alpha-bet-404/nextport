...
Any derivative works, forks, or redistributions of this software MUST prominently display the original author's name "alpha-bet" and a link to the original repository (https://github.com) in the software's documentation, source code, and user interface.
